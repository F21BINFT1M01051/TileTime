...
const EventLive = ({ visible, onClose }) => {
            ...
            <Animated.View style={[styles.modalContent, { transform: [{ translateY: slideAnim }] }]}>
              <View style={styles.modalInnerContent}>
                ...
                <View style={styles.headerRow}>
                  <Image source={ICONS.gp3} resizeMode="contain" style={styles.gpImage} />
                  <View style={styles.centerContent}>
                    <Image source={ICONS.greenCheck} resizeMode="contain" style={styles.greenCheck} />
                    <View style={styles.liveTextContainer}>
                      <Text style={styles.liveText}>Your Event Is Live!</Text>
                      <Image source={ICONS.stars2} resizeMode="contain" style={styles.stars} />
                    </View>
                  </View>
                  <Image source={ICONS.gp1} resizeMode="contain" style={styles.gpImageRight} />
                </View>
                ...
                <Image source={ICONS.gp2} resizeMode="contain" style={styles.gp2} />
                ...
                <View style={styles.qrSection}>
                  <Image source={ICONS.qr} resizeMode="contain" style={styles.qrImage} />
              ...
              <View style={styles.modalFooter}>
                <View style={styles.modalFooterInner}>
                  <SocialField name="Go to Dashboard" onPress={()=> {
                    onClose()
