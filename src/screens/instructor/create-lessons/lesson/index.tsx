      ...
      >
        <View style={styles.container}>
          ...
          <EventLiveLessons
            ...
            subtitle={`You’ve Set Up Your Mahjong Lesson\n It’s Now Ready To Share Or Manage.`}
          />
        </View>
      </KeyboardAvoidingView>
    </TouchableWithoutFeedback>
...
export default CreateLessonInstructor;
